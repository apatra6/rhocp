#include "AssignSubdomainIDfromFeature.h"
#include "MooseMesh.h"
...
registerMooseObject("RhocpApp", AssignSubdomainIDfromFeature);

InputParameters
AssignSubdomainIDfromFeature::validParams()
{
...
AssignSubdomainIDfromFeature::AssignSubdomainIDfromFeature(const InputParameters & parameters)
...
AssignSubdomainIDfromFeature::generate()
{
...
void
AssignSubdomainIDfromFeature::readEBSDfile()
{
...
AssignSubdomainIDfromFeature::getData(const Point & p) const
{
  return _data[indexFromPoint(p)];
}

unsigned int
AssignSubdomainIDfromFeature::indexFromPoint(const Point & p) const
{
