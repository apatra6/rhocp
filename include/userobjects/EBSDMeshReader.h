#ifndef EBSDMESHREADER_H
#define EBSDMESHREADER_H
 ...
 */
class EBSDMeshReader : public EulerAngleProvider, public EBSDAccessFunctors
{
public:
  static InputParameters validParams();

  EBSDMeshReader(const InputParameters & params);
  virtual ~EBSDMeshReader();
