...
class DDCP_SSD_StressUpdate : public ComputeStressBase
{
public:
  static InputParameters validParams();

  DDCP_SSD_StressUpdate(const InputParameters & parameters);
  virtual ~DDCP_SSD_StressUpdate();
