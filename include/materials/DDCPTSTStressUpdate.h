...
class DDCPTSTStressUpdate : public ComputeStressBase
{
public:
  static InputParameters validParams();

  DDCPTSTStressUpdate(const InputParameters & parameters);
  virtual ~DDCPTSTStressUpdate();
...
protected:
  ...
  Real C11, C11_perK, C12, C12_perK, C44, C44_perK, G, G_perK, b_mag, gammadot0g, enthalpy_const, p, q, p0, tau0, hp_coeff, grain_size, frictional_stress, k_rho, k_I, Alatent, rho_m_zero, rho_i_zero, d_disl_zero, k_M, R_c, k_ann, k_D, k_bs1, k_bs2, B_k, attempt_freq;
