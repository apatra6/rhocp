#ifndef ASSIGNSUBDOMAINIDFROMPHASE_H
#define ASSIGNSUBDOMAINIDFROMPHASE_H
 ...
 */
class AssignSubdomainIDfromPhase : public MeshGenerator, public EBSDAccessFunctors
{
public:
  static InputParameters validParams();

  AssignSubdomainIDfromPhase(const InputParameters & parameters);
